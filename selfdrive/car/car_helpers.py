...
from selfdrive.version import comma_remote, vw_community_remote, edu_remote, tested_branch
...
def get_startup_event(car_recognized, controller_available):
  if (comma_remote or vw_community_remote or edu_remote) and tested_branch:
